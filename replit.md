...
- **Username Assignment for Legacy Users** (January 2025): Assigned usernames matching first names to all existing users who created accounts before username system was implemented - Lucas, Murilo, Edward, and Cake all received usernames matching their display names
