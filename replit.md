...
- **Premium Tournament Creation** (January 2025): Restricted tournament creation to premium users only while maintaining free access to joining existing tournaments, encouraging subscription upgrades for tournament organizers
...
- **Special #1 Leaderboard Achievements** (January 2025): Added 3 unique special achievements with custom gradient designs: Tournament Overlord (yellow-orange-red), Portfolio Emperor (purple-pink-red), and Streak Master (blue-cyan-green) - automatically awarded to users who rank #1 on their respective leaderboards