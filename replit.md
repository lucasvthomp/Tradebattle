...
- **Dynamic Historical Close Price Column** (January 2025): Updated watchlist "Previous Close" column to dynamically display historical close prices based on selected timeframe - showing Close Price (1D), Close Price (5D), etc. with actual historical data from Yahoo Finance