...
export function AdvancedOrderDialog({
  isOpen,
  onClose,
  onConfirm,
  initialOrder,
  balance
}: AdvancedOrderDialogProps) {
  ...
  const getActionLabel = () => {
    switch (initialOrder.action) {
      case 'buy': return 'Buy';
      case 'short_sell': return 'Short Sell';
      case 'short_cover': return 'Cover Short';
  ...
  const getActionColor = () => {
    switch (initialOrder.action) {
      ...
      case 'short_sell': return 'text-red-600';
      case 'short_cover': return 'text-blue-600';
  ...
  const getActionIcon = () => {
    switch (initialOrder.action) {
      ...
      case 'short_sell': return <TrendingDown className="w-5 h-5" />;
      case 'short_cover': return <Shield className="w-5 h-5" />;
      default: return null;
    }
  };
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Automatically sell if price drops to minimize losses
                  </p>
                </div>
                <Switch
            ...
            <div className="p-4 rounded-lg border border-border space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Automatically sell when price reaches target profit
                  </p>
                </div>
                <Switch
        ...
        <DialogFooter>
          ...
          <Button
            ...
            className={
              initialOrder.action === 'buy' ? 'bg-green-600 hover:bg-green-700' :
              initialOrder.action === 'short_sell' ? 'bg-red-600 hover:bg-red-700' :
