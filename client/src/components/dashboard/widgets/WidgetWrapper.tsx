...
export function WidgetWrapper({
  ...
  return (
    <div className={`h-full flex flex-col bg-card/95 backdrop-blur-sm border border-border/50 rounded-lg overflow-hidden cursor-move shadow-md hover:shadow-lg transition-shadow ${className}`}>
