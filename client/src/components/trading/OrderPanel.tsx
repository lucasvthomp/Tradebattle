...
export function OrderPanel({
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="p-3 space-y-2" style={{ borderBottom: "1px solid #0E2040" }}>
        <div>
          ...
          >
            <SelectTrigger
              className="h-9"
              style={{ backgroundColor: 'transparent', borderColor: "#0E2040", color: "#67E7BF" }}
            >
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-semibold" style={{ color: "#67E7BF" }}>
      ...
      <div className="px-3 py-2.5" style={{ borderBottom: "1px solid #0E2040" }}>
            ...
            {isSearching ? (
              ...
              searchResults.map((result: any) => (
                <button
                  ...
                  className="w-full px-4 py-3 text-left hover:bg-[#091525] flex items-center justify-between transition-colors"
                  style={{
                    borderBottom: "1px solid rgba(31, 41, 55, 0.5)",
                    backgroundColor: result.symbol === symbol ? "#091525" : "transparent",
                  }}
                >
      ...
      <div className="p-4 space-y-4">
                ...
                {maxBuyShares > 0 && (
                  <button
                    ...
                    style={{
                      ...
                      color: quantity === maxBuyShares ? "#10B981" : "#67E7BF",
                  ...
                  <>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: quantity === ownedShares ? "#EF4444" : "#67E7BF",
        ...
        <Separator style={{ backgroundColor: "#0E2040" }} />
