  ...
  return (
    <div className="flex space-x-2">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start" style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040' }}>
          <DropdownMenuItem
  ...
  return (
    ...
    >
            ...
            <div className="p-3 relative" style={{ borderTop: '1px solid #0E2040', backgroundColor: 'rgba(10, 18, 38, 0.92)' }}>
              ...
              {showMentions && mentionSuggestions.length > 0 && (
                <div
                  ...
                  style={{ backgroundColor: '#1E2D3F', border: '1px solid #0E2040' }}
                >
      ...
      <Dialog open={tipDialogOpen} onOpenChange={setTipDialogOpen}>
        <DialogContent style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040' }}>
          <DialogHeader>
