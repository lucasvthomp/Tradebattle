...
export function TournamentStartDialog({ isOpen, onClose, tournament }: TournamentStartDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden" style={{ backgroundColor: 'transparent', borderColor: '#67E7BF', border: '2px solid' }}>
        {/* Animated Background */}
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                background: 'radial-gradient(circle, #67E7BF, transparent)',
              }}
              animate={{
                y: ['-10%', '110%'],
                opacity: [0, 0.6, 0],
        ...
        <div className="relative">
          ...
          <div className="relative px-8 pt-8 pb-6 text-center">
            ...
            <motion.h1
              ...
              style={{
                background: 'linear-gradient(135deg, #67E7BF, #FFD700, #67E7BF)',
          ...
          >
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="p-4 rounded-xl" style={{ background: 'linear-gradient(135deg, rgba(0, 163, 255, 0.1), rgba(0, 163, 255, 0.05))' }}>
                <div className="flex items-center gap-2 mb-2">
                  <DollarSign className="w-5 h-5" style={{ color: '#67E7BF' }} />
            ...
            <div className="p-6 rounded-xl mb-6" style={{ backgroundColor: 'transparent', border: '1px solid #0E2040' }}>
              ...
              <ul className="space-y-3 text-sm" style={{ color: '#C9D1E2' }}>
                <li className="flex items-start gap-2">
                  <TrendingUp className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#67E7BF' }} />
                ...
                <li className="flex items-start gap-2">
                  <DollarSign className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#67E7BF' }} />
            ...
            <Button
              ...
              style={{
                background: 'linear-gradient(135deg, #67E7BF, #FFD700)',
                color: '#091525',
              }}
            >
              Make your move! 🚀
