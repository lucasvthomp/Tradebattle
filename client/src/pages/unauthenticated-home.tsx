...
const promoCards = [
  {
    ...
    cta: "Enter arenas",
    art: "/assets/tradebattle-visuals/market-chart.png",
  },
  {
    href: "/blitz",
    ...
    cta: "Play Blitz",
    art: "/assets/tradebattle-visuals/swords.png",
  },
  {
    href: "/shop",
    ...
    cta: "Visit rewards",
    art: "/assets/tradebattle-visuals/chest.png",
  },
];
        ...
        <div className="arena-shell">
          ...
          <div className="arena-hero-layout">
            ...
            <div className="arena-hero-visual">
              ...
              <img className="arena-hero-mascot" src="/assets/tradebattle-visuals/market-chart.png" alt="" aria-hidden="true" />
