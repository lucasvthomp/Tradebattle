          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <Card className="mt-8">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      <h2 className="text-2xl font-bold text-black">Recent Studies</h2>
                    ...
                    {studiesLoading ? (
                      ...
                      <div className="space-y-4">
                        {recentStudies.slice(0, 3).map((study, index) => (
                          ...
                          >
                            <div>
                              <h3 className="font-semibold text-black">{study.title}</h3>
                      ...
                      <div className="text-center py-8">
                        <p className="text-gray-600">No studies available at the moment.</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
              ...
              <div className="space-y-8">
                ...
                <Card>
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold text-black mb-4">Breaking News</h3>
                    {newsLoading ? (
                      <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        {breakingNews.slice(0, 2).map((news, index) => (
                          ...
                          >
                            ...
                            <h4 className="font-semibold text-black text-sm">{news.title}</h4>
                      ...
                      <div className="text-center py-4">
                        <p className="text-gray-600 text-sm">No breaking news at the moment.</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold text-black mb-4">Market Sentiment</h3>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600">Weekend Impact</span>
