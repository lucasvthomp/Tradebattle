...
export default function ArchiveDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-[calc(100dvh-4rem)] flex items-center justify-center" style={{ backgroundColor: 'transparent' }}>
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      {/* Tournament Header */}
      <Card className="mb-6" style={{ backgroundColor: '#0C1A2E', borderColor: '#0E2040' }}>
