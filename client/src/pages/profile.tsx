...
export default function Profile() {
  ...
  const achievements = [
    ...
    { id: 7, name: "5% Portfolio Growth", description: "Made over 5% on any portfolio", icon: TrendingUp, rarity: "rare", color: "bg-blue-200 text-blue-900 dark:bg-blue-700 dark:text-blue-100" },
    // Epic (Rich Purple)
    ...
    { id: 10, name: "10% Portfolio Growth", description: "Made over 10% on any portfolio", icon: TrendingUp, rarity: "epic", color: "bg-purple-200 text-purple-900 dark:bg-purple-700 dark:text-purple-100" },
