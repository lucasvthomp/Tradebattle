    ...
    <div className="flex items-center -space-x-2">
      ...
      {overflow > 0 && (
        <div
          ...
          style={{ backgroundColor: '#1E2D3F', color: '#E3B341', border: '2px solid #0C1A2E' }}
        >
          +{overflow}
        </div>
      )}
...
export default function TournamentsPage() {
  ...
  if (!user) {
    return (
      <div className="h-[calc(100vh-4rem)] flex items-center justify-center" style={{ background: 'linear-gradient(to bottom, #080C14, #091525)' }}>
  ...
  return (
    <div className="h-[calc(100vh-4rem)] overflow-auto" style={{ background: 'linear-gradient(to bottom, #080C14, #091525)' }}>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center" style={{ gap: 'clamp(8px, 1vw, 16px)' }}>
              <Dialog open={joinCodeDialogOpen} onOpenChange={setJoinCodeDialogOpen}>
                ...
                <DialogContent className="max-w-[95vw] md:max-w-md" style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040' }}>
                  <DialogHeader>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-1">
              ...
              <Select value={filterType} onValueChange={setFilterType}>
                <SelectTrigger className="w-full sm:w-40" style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040', color: '#F1F5F9' }}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040' }}>
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-full sm:w-48" style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040', color: '#F1F5F9' }}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent style={{ backgroundColor: '#1E2D3F', borderColor: '#0E2040' }}>
